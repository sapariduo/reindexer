...
execute_process(
  COMMAND "/usr/bin/git" show-ref b50b7b7a8c2835b45607cffabc18e4742072e9e6
  WORKING_DIRECTORY "/home/vagrant/MDM/reindexer/build/cpp_src/cmd/reindexer_tool/replxx_lib-prefix/src/replxx_lib"
...
if("${show_ref_output}" MATCHES "refs/remotes/b50b7b7a8c2835b45607cffabc18e4742072e9e6")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "b50b7b7a8c2835b45607cffabc18e4742072e9e6")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "b50b7b7a8c2835b45607cffabc18e4742072e9e6")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 b50b7b7a8c2835b45607cffabc18e4742072e9e6
  WORKING_DIRECTORY "/home/vagrant/MDM/reindexer/build/cpp_src/cmd/reindexer_tool/replxx_lib-prefix/src/replxx_lib"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/Restream/replxx'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/vagrant/MDM/reindexer/build/cpp_src/cmd/reindexer_tool/replxx_lib-prefix/src/replxx_lib/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/vagrant/MDM/reindexer/build/cpp_src/cmd/reindexer_tool/replxx_lib-prefix/src/replxx_lib/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
